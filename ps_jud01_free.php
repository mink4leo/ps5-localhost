...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark "  style="background-color: #da30f8;">
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    <div class="col-sm-4 text-right">
                        <input type="submit" name="submitA" class="btn btn-success btn-lg btn-block"  style="background-color: #da30f8;" value="SUBMIT">
                    </div>
                </div>
